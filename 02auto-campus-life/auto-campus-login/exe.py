...
url='http://202.202.145.132/eportal/InterFace.do?method=login' #在此处替换抓包得到的登陆报文URL
...
headers={
    ...
    'Content-Length':'940', #填写抓包得到的值
    'Content-Type':'application/x-www-form-urlencoded; charset=UTF-8',
    'Cookie': 'EPORTAL_COOKIE_PASSWORD=; servicesJsonStr=12123020433%40%25%25username%40%25%25%E4%B8%AD%E5%9B%BD%E7%94%B5%E4%BF%A1%40%E6%A0%A1%E5%9B%AD%E5%86%85%E7%BD%91%40%E4%B8%AD%E5%9B%BD%E7%A7%BB%E5%8A%A8; EPORTAL_COOKIE_OPERATORPWD=; EPORTAL_COOKIE_DOMAIN=; EPORTAL_COOKIE_USERNAME=12123020433; EPORTAL_COOKIE_SERVER=%E4%B8%AD%E5%9B%BD%E7%A7%BB%E5%8A%A8; EPORTAL_COOKIE_SERVER_NAME=%E4%B8%AD%E5%9B%BD%E7%A7%BB%E5%8A%A8; EPORTAL_COOKIE_SAVEPASSWORD=true; JSESSIONID=168879B8433357FEBC5F2FD6C9C5F87D', #填写抓包得到的cookie
    'Host':'202.202.145.132', #填写抓包得到的host
    'Origin':'http://202.202.145.132', #填写抓包得到的origin
    'Pragma':'no-cache',
    'Referer':'http://202.202.145.132/eportal/index.jsp?wlanuserip=f3639c6fccb1e7be61065a9627f56884&wlanacname=678091c499ce14d5f17e57f207341c3e&ssid=&nasip=aef6b29f10a395e5281558a383e32a56&snmpagentip=&mac=50979ceabad4baa5ee0ac4db5c81e75c&t=wireless-v2&url=d0752b48a62469db6e2c38ca77babc6e6ab4838182251048&apmac=&nasid=678091c499ce14d5f17e57f207341c3e&vid=7e3b3c169bb08265&port=e8b129e098269ba3&nasportid=9b1904c7c6d339b9fa9fb66740cc3ff72d8190d8ad24ca361f633990affc7ab5' #填写抓包得到的referer
}
#<------headers结束------>

#<------将抓包得到的载荷内容填写到键值对中------>
data={
    'userId':'12123020433', #填写抓包得到的userId
    'password':'', #填写抓包得到的password
    'service':'%E4%B8%AD%E5%9B%BD%E7%A7%BB%E5%8A%A8', #填写抓包得到的service
...
log.write('状态码：\n' + str(respond.status_code) + '\n\n')

log.write('响应头信息：\n' + respond.headers.__str__() + '\n\n')
